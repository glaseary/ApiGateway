package com.Perfulandia.ApiGateway.redireccion.soportes;
...
public class SoportesProxyController {
    ...
    public ResponseEntity<?> proxySoporte(HttpServletRequest request,
        ...
        String targetUrl = "http://localhost:8002/api/soporte" + originalPath;
